...
#!/usr/bin/env python3
"""
Fix simple inventory database structure to match the model
"""

import sqlite3
from datetime import datetime

def fix_simple_inventory_database():
    """Fix the simple_inventory_items table structure"""
    print("🔧 Fixing simple inventory database structure...")
    ...
    try:
        ...
        if not table_exists:
            ...
            cursor.execute("""
                CREATE TABLE simple_inventory_items (
                    ...
                    last_sale_date DATE,
                    total_purchased FLOAT DEFAULT 0.0,
                    total_sold FLOAT DEFAULT 0.0,
                    total_adjustments FLOAT DEFAULT 0.0
                )
            """)
            ...
            required_columns = {
                ...
                'date_added', 'last_updated', 'last_counted_date',
                'last_purchase_date', 'last_sale_date', 'total_purchased',
                'total_sold', 'total_adjustments'
            }
        ...
        print("✅ Simple inventory database structure fixed successfully!")
        return True
