...
class SimpleStockTransaction(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    item_id = db.Column(db.Integer, db.ForeignKey('simple_inventory_items.id'), nullable=False)
    transaction_type = db.Column(db.String(50), nullable=False)
    quantity_change = db.Column(db.Float, nullable=False)
    new_stock_level = db.Column(db.Float, nullable=False)
...
class SimpleLowStockAlert(db.Model):
    ...
    __tablename__ = 'simple_low_stock_alerts'
    ...
    acknowledged_by_user = db.relationship('User')
...
# Simple Inventory Management Models - New Simplified System
class SimpleInventoryItem(db.Model):
    ...
    # Relationships
    transactions = db.relationship('SimpleStockTransaction', backref='item', lazy=True)
